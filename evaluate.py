...
class Evaluater():
    def __init__(self, args):
        ...
        self.maxDepth = max_depths[args.data]
        self.res_dict = resolutions[args.data]
        ...
        # self.model = load_model(args.weights_path)
        self.model.to(self.device)

        self.test_loader = dataset.get_dataloader(args.data,
                                                 path=args.test_path,
                                                 split='test',
                                                 batch_size=1,
